...
import {
  LayoutDashboard, Bot, MessageSquare, Shield, Clock, Puzzle,
  Store, Settings, Link2, LogOut, PanelLeft, Cog
} from "lucide-react";
        ...
        <div className="flex flex-col items-center gap-8 p-8 max-w-md w-full">
          <div className="flex flex-col items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-2xl font-bold tracking-tight">Shashclaw</h1>
            </div>
            <p className="text-sm text-muted-foreground text-center max-w-sm">
              Secure AI Agent Platform. Sign in to manage your agents.
            </p>
          </div>
          <Button
            ...
            <div className="flex items-center gap-3 px-2 transition-all w-full">
              ...
              {!isCollapsed && (
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  <span className="font-bold tracking-tight truncate text-sm">Shashclaw</span>
                </div>
              )}
            </div>
          </SidebarHeader>
